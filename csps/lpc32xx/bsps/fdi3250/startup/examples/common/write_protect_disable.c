...
/* Sample test board disable functions:
   ...
   Embedded Artists 3250 NAND : gpio_set_gpo_state(P3_STATE_GPO(19), 0)
   Embedded Artists 3250 SPI  : Always write enabled
   NXP VAL3250_2 board NAND   : gpio_set_gpo_state(P3_STATE_GPO(19), 0)
   NXP VAL3250_2 board SPI    : Not software controllable (jumper JP11)
   FDI 3250 NAND              : gpio_set_gpo_state(P3_STATE_GPO(19), 0)
*/
