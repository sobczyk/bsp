...
/* Pick one system type below. Be sure to also edit the defines for
   the selected system type in the dram_configs.h file.
   0 = Low power SDR SDRAM (1.8v)
   1 = Standard SDR SDRAM (3.3v)
   2 = Low power DDR SDRAM (1.8v)
   3 = Standard power DDR SDRAM (2.5v)
   All other values = no SDRAM
*/
#define SDRAM_SDR_LP 0
#define SDRAM_SDR_ST 1
#define SDRAM_DDR_LP 2
#define SDRAM_DDR_ST 3
#define SDRAM_OPTION SDRAM_SDR_ST

/* If using the same SDRAM parts on both the DYSC0 and DYCS1 chip
   selects, enable the following define */
/*
