 ...
 *
 * Project: Simple large block NAND erase program
 *
 * Description:
 *     Erases the start of large block NAND to prevent NAND boot.
 *
 ***********************************************************************
...
void c_entry(void)
{
  ...
  /* Erase first block */
  if (nand_lb_mlc_erase_block(0) == 0)
  {
  ...
  {
    uart_output((UNS_8*)"Block 0 erased\r\n");
  }
