/***********************************************************************
 * $Id:: board_slc_nand_sb_driver.c 3409 2010-05-06 19:37:38Z usb10132 $
 *
...
INT_32 nand_sb_slc_is_block_bad(UNS_32 block)
{
	...
	/* Bad Block markers will be at offsets 5 and 4 */
	bbmark = spare[NAND_SB_BADBLOCK_OFFS - 512]; 
	bbmark &= spare[NAND_SB_BADBLOCK_OFFS - 512 - 1]; 
	if(bbmark == NAND_GOOD_BLOCK_MARKER)
	{
		badblock = 0;
	}
	else
								...
								UNS_8 *spare)
{
	...
	/* ECC will be ready by now, prepare and transfer */
