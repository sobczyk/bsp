...
/* SSP driver flag */
static INT_32 sspid = 0;
/***********************************************************************
 *
 * Function: board_ssp_gpio_setup
 *
 * Purpose: Configure Some of the GPIO pins into SSP mode
 *
 * Processing:
 *     See function.
 *
 ...
 *
 **********************************************************************/
void board_ssp_gpio_setup(void)
{
...
void board_spi_config(void)
{
	...
	if(!sspid)
	{
		/* Configure Pin Muxing in SSP mode */	
		board_ssp_gpio_setup();
