/***********************************************************************
 * $Id:: kickstart_sb_nand.c 3417 2010-05-06 19:58:45Z usb10132        $
 *
 * Project: Kickstart loader from small block NAND FLASH
 *
 * Description:
 *     This file contains a sample kickstart loader that can be used
 *     to load a larger stage 1 application from small block NAND
 *     FLASH.
 *
 ***********************************************************************
